...
- **날씨 정보 제공**: 실시간 날씨 API를 통해 주요 여행지의 날씨 정보를 제공하여 여행 계획에 도움을 줍니다.
...
- **주요 특징**:
  ...
  <img width="1012" alt="스크린샷 2025-06-16 오후 9 53 34" src="https://github.com/user-attachments/assets/5840c9bd-8b85-47c6-9748-0c1a6d9afc8b" />

  <img width="1012" alt="스크린샷 2025-06-16 오후 9 53 44" src="https://github.com/user-attachments/assets/b22a9ac8-6f06-46c5-a174-aa103efa76a5" />

### 6. 날씨 정보 제공
- **기능 개요**: 실시간 날씨 API를 통합하여 주요 동남아 여행지의 현재 날씨 정보를 제공합니다. 사용자는 여행 계획 시 날씨를 고려하여 더 나은 결정을 내릴 수 있습니다.
- **주요 특징**:
  - 주요 도시(방콕, 다낭, 발리 등)의 실시간 날씨 데이터 표시.
  - 상세 페이지 내에서 해당 지역의 날씨 정보를 바로 확인 가능.
  - 날씨 정보는 온도, 습도, 강수량 등 주요 지표를 포함.
- **접근 제한**: 로그인한 회원만 상세 페이지에서 날씨 정보를 확인할 수 있습니다.
 
<img width="712" alt="스크린샷 2025-06-18 오전 1 53 22" src="https://github.com/user-attachments/assets/1e3ce963-85d0-4576-8099-da782da22302" />
